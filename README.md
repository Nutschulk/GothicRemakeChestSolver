...
https://nutschulk.github.io/GothicRemakeChestSolver/

If you kept the file name instead of renaming to index.html, use:
https://nutschulk.github.io/GothicRemakeChestSolver/gothic-lock-solver.html
...
Rename gothic-lock-solver.html to **index.html**
